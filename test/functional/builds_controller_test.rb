...
class BuildsControllerTest < ActionController::TestCase
  ...
  test "should create build" do
    assert_difference('Build.count') do
      post :create, build: { cpu: @build.cpu, name: @build.name, owner: @build.owner, project: @build.project, ticket_no: @build.ticket_no }
    end
  ...
  test "should update build" do
    put :update, id: @build, build: { cpu: @build.cpu, name: @build.name, owner: @build.owner, project: @build.project, ticket_no: @build.ticket_no }
    assert_redirected_to build_path(assigns(:build))
  end
